...
/*
	...
	Example Url : [controller] / [method] / [action] - admin/news/edit
	...
	class Admin
	{
		...
		function __construct()
		{
			...
			$this->eprotect->protectMe( [method], [action] ); // first param is [your dynamic page name], second param [your dynamic page action]
		}
